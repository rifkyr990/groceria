            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full rounded-lg border px-3 py-3 text-sm shadow-sm focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500 pr-10"
                        placeholder="Masukkan password lama"
                    />
                    <button
                        type="button"
                        onClick={() => setShowOldPassword(!showOldPassword)}
                        className="absolute top-[39px] right-3 text-gray-500 hover:text-gray-700"
                        tabIndex={-1}
                    >
