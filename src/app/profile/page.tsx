...
export default function ProfilePage() {
  ...
  // hydrate user dari localStorage
    useEffect(() => {
        hydrate();
    }, []);

  // set form value ketika user berubah
    useEffect(() => {
        if (user) {
    ...
    const handleImageChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (!success) {
            toast.error("Gagal update foto profil");
        }
    };
        ...
        <div className="max-w-3xl mx-auto p-6">
            ...
            >
                ...
                <div className="flex justify-end gap-4 mt-10">
                    ...
                    <button type="submit" className="w-45 bg-green-600 text-white py-2 rounded-lg hover:bg-blue-700">
                        Simpan Perubahan
                    </button>
                </div>
            </form>
