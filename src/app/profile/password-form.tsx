        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                    ...
                    <input type="password" {...register("oldPassword", { required: true })} className="w-full rounded-lg border px-3 py-3 text-sm shadow-sm focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500" placeholder="Masukan Password lama" />
                </div>
