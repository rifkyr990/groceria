        ...
        <section className="max-w-7xl mx-auto px-6 py-3 flex flex-col">
            ...
            <div className="flex gap-3 mb-6 flex-wrap">
                ...
                <button
                    ...
                    selectedCategory === cat
                        ...
                        : "bg-white text-gray-700 border-gray-300 hover:bg-gray-100 dark:bg-gray-900 dark:text-gray-100"
                    }`}
                >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-5">
                {currentProducts.map((product) => (
                    <div
                        key={product.id}
                        className="group bg-white rounded-2xl shadow-md hover:shadow-lg transition overflow-hidden flex flex-col justify-center "
                    >
            ...
            <div className="flex justify-center mt-8 gap-2">
                <button
                    ...
                    className="px-4 py-2 rounded-lg border text-gray-700 bg-white disabled:opacity-50 dark:bg-gray-900 dark:text-gray-100"
                >
                    Sebelumnya
                </button>
